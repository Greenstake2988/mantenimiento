...
$anio = $_GET['anio'];
$_SESSION['anio'] = $anio;
$sql_orden = "select * from orden_mantenimiento where folio='$folio' and anio_folio='$anio'";
...
$sql_solicitante = "select id_usuario from solicitudes where folio='$folio' and anio_folio='$anio'";
...
?>
    ...
    <table width="900" height="593" align="center" border="0">
  <!--DWLayoutTable-->
  <tr>
  ...
  <tr>
    <td colspan="2" align="left" valign="top">
      ...
      <tr>
          ...
          <?php if($_SESSION['sol']=='cc'){echo "CP. DARRYL BRIAN CERVERA CANTO";}else{echo'CP. MARCO AURELIO VIVAS &Aacute;LVAREZ';} ?>
        </p></td>
