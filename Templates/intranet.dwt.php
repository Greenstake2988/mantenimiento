...
<div id="menu"><!-- TemplateBeginEditable name="menu" -->menu<!-- TemplateEndEditable --></div>
<div id="contenido"><!-- TemplateBeginEditable name="contenido" -->contenido<!-- TemplateEndEditable --></div>
<div id="sub-seccion"><!-- TemplateBeginEditable name="EditRegion5" -->EditRegion5<!-- TemplateEndEditable --></div>
