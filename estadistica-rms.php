...
<table width="1000" border="0" align="center" bordercolor="#333333">
  ...
  <form name="estadistica" method="post">
    <p align="right">
	 ...
	 $solicitudes=mysql_query(" select count(pendiente) from solicitudes where fecha between "."'"."$fecha1"."'"."AND"."'" ."$fecha2 "."'"."AND solicita_a='rms'  " );
  while ($total_solicitudes=mysql_fetch_array($solicitudes))
   ...
   $atendidos=mysql_query("select count(pendiente) from solicitudes where fecha between "."'"."$fecha1"."'"."AND"."'" ."$fecha2 "."'"."AND solicita_a='rms' and pendiente=1  ");
