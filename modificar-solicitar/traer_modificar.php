...
<table width="1000" border="0" align="center" bordercolor="#333333">
  ...
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="EditRegion3" -->
        <form  name="form1" method="post" action="Formato_solicitud/Formsolicitud.php" >
		<?php 
		...
		if($_SESSION['sol']=='cc'){	
		$consulta=mysql_query( "SELECT folio,anio_folio,fecha,solicita_a,falla_reparar,id_area,id_usuario from solicitudes where folio='$buscar_folio' and anio_folio='$buscar_anio' and solicita_a='cc'",$enchufarsolicitudes);
