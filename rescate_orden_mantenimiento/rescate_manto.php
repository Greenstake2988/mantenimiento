...
$sql_orden = "select * from orden_mantenimiento where folio='$folio' and folio_r='$folio_r'";
...
$sql_solicitante = "select id_usuario from solicitudes where folio='$folio' and solicita_a='$sol'";
...
?>
  ...
  <tr>
    ...
    <tr>
          <td><img src="../../imagenes/encabezadoformatocalidad.png"></td>
        </tr>
    </table>
    </td>
  </tr>
  ...
  <tr>
    <td colspan="2" align="left" valign="top">
      ...
      <tr>
        <td width="448" height="37" valign="top" class="celdasbajo2"><p><strong>Verificado y Liberado por:</strong><?php echo $n_completo_s;?></p></td>
      ...
      <tr>
          ...
          <?php if($_SESSION['sol']=='cc'){echo "VIRGILIO ANTONIO CHIMAL COUOH";}else{echo'NARDO LEONEL BALAM &Aacute;LVAREZ';} ?>
        </p></td>
  ...
  <tr>
    ...
    <td align="center">Carretera Valladolid - Tizim&iacute;n, Km. 3.5 Tablaje Catastral No. 8850<br />
                Valladolid, Yucat&aacute;n, M&eacute;xico, C.P. 97780,<br />
                Tel&eacute;fono 985 - 856 - 6300<br />
                <strong>www.itsva.edu.mx</strong>
    </td>
    <td align="right">
      Julio 2017<br />
      <img src="../../imagenes/9001-2015.jpg" width="50">
      <img src="../../imagenes/14001-2015.jpg" width="50">
      <img src="../../imagenes/OHSAS18001-2007.jpg" width="50">
    </td>
  </tr>
  </table>
    </td>
