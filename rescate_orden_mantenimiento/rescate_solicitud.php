...
?>
  ...
  <tr>
    <td><table width="754" border="0" cellpadding="0" cellspacing="0" class="tablacompleta">
    <tr>
  ...
  <tr>
    <td>
      <p align="center"><strong>SOLICITUD DE MANTENIMIENTO CORRECTIVO</strong></p>
      <br />
      ...
      <td valign="top"> <div><center><?php if($_SESSION['sol']=='cc'){echo $marca_x;}?></center></div></td>
       ...
       <div style="float: right; margin-top: 18px; padding-right: 5px;">Folio: <label class="subnegritas"><?php printf("_%'03s\n", $folio);?></label>
          <span class="subnegritas"><?php printf("%'03s\n_", $datos_solicitud->anio_folio);?></span> </div>
      <p>&nbsp;</p>
        <p>&nbsp;</p>
...
&nbsp;&Aacute;rea Solicitante: <?php echo $array_area[1];?></p>
  ...
  <tr>
    <td><br />
	<table border="0" cellspacing="0" cellpadding="0" width="754" class="tabla">
      <tr>
