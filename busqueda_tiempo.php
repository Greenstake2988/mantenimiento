...
<table width="1000" border="0" align="center" bordercolor="#333333">
  ...
  <form name="estadistica-fechas" method="post" action="tiempo_atencion.php">
      <p align="right"><a href="menuadmin.php"><img src="imagenes/inicio.png" border="0" /></a>
    <p>
      <table  width="516" height="228" border="0" align="center" cellpadding="4" bgcolor="#CCCCCC" class="tabla" >
          <tr>
            <td height="23" colspan="3" align="center" valign="middle" ><p class="title">Demora en mantenimientos</p>
                <p>Seleccione el periodo de atenci&oacute;n a consultar</p></td>
          </tr>
          <tr>
